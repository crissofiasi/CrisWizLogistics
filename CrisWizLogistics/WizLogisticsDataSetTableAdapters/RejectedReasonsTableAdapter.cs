...
// Type: WizLogistics.WizLogisticsDataSetTableAdapters.RejectedReasonsTableAdapter
...
namespace CrisWizLogistics.WizLogisticsDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class RejectedReasonsTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    public RejectedReasonsTableAdapter()
    {
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(WizLogisticsDataSet.RejectedReasonsDataTable dataTable, int? UserID)
    {
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual WizLogisticsDataSet.RejectedReasonsDataTable GetData(int? UserID)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (!UserID.HasValue)
        this.Adapter.SelectCommand.Parameters[1].Value = (object) DBNull.Value;
        ...
        this.Adapter.SelectCommand.Parameters[1].Value = (object) UserID.Value;
      WizLogisticsDataSet.RejectedReasonsDataTable reasonsDataTable = new WizLogisticsDataSet.RejectedReasonsDataTable();
      this.Adapter.Fill((DataTable) reasonsDataTable);
      return reasonsDataTable;
    }
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "RejectedReasons"
      };
      dataTableMapping.ColumnMappings.Add("RejectedReasonID", "RejectedReasonID");
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.GetRejectedReasons";
