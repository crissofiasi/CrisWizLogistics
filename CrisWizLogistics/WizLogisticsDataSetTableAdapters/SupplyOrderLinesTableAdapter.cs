...
// Type: WizLogistics.WizLogisticsDataSetTableAdapters.SupplyOrderLinesTableAdapter
...
namespace CrisWizLogistics.WizLogisticsDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class SupplyOrderLinesTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    public SupplyOrderLinesTableAdapter()
    {
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "SupplyOrderLines"
      };
      dataTableMapping.ColumnMappings.Add("SupplyOrderLineID", "SupplyOrderLineID");
      ...
      dataTableMapping.ColumnMappings.Add("MeasureUnit", "MeasureUnit");
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.GetSupplyOrderLines";
      ...
      this._commandCollection[0].Parameters.Add(new SqlParameter("@SupplyOrderID", SqlDbType.BigInt, 8, ParameterDirection.Input, (byte) 19, (byte) 0, (string) null, DataRowVersion.Current, false, (object) null, "", "", ""));
    }
