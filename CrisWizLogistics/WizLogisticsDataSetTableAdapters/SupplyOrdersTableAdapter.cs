...
// Type: WizLogistics.WizLogisticsDataSetTableAdapters.SupplyOrdersTableAdapter
...
namespace CrisWizLogistics.WizLogisticsDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class SupplyOrdersTableAdapter : Component
  {
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(WizLogisticsDataSet.SupplyOrdersDataTable dataTable, int? UserID)
    {
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual WizLogisticsDataSet.SupplyOrdersDataTable GetData(int? UserID)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (!UserID.HasValue)
        this.Adapter.SelectCommand.Parameters[1].Value = (object) DBNull.Value;
        ...
        this.Adapter.SelectCommand.Parameters[1].Value = (object) UserID.Value;
      WizLogisticsDataSet.SupplyOrdersDataTable supplyOrdersDataTable = new WizLogisticsDataSet.SupplyOrdersDataTable();
      this.Adapter.Fill((DataTable) supplyOrdersDataTable);
      return supplyOrdersDataTable;
    }
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "SupplyOrders"
      };
      dataTableMapping.ColumnMappings.Add("SupplyOrderID", "SupplyOrderID");
      dataTableMapping.ColumnMappings.Add("DocInfo", "DocInfo");
      dataTableMapping.ColumnMappings.Add("SupplierName", "SupplierName");
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.GetSupplyOrders";
