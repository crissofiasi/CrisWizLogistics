...
// Type: WizLogistics.WizLogisticsDataSetTableAdapters.WarehousesTableAdapter
...
namespace CrisWizLogistics.WizLogisticsDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class WarehousesTableAdapter : Component
  {
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(WizLogisticsDataSet.WarehousesDataTable dataTable, int? UserID)
    {
    ...
    [GeneratedCode("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual WizLogisticsDataSet.WarehousesDataTable GetData(int? UserID)
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      if (!UserID.HasValue)
        this.Adapter.SelectCommand.Parameters[1].Value = (object) DBNull.Value;
        ...
        this.Adapter.SelectCommand.Parameters[1].Value = (object) UserID.Value;
      WizLogisticsDataSet.WarehousesDataTable warehousesDataTable = new WizLogisticsDataSet.WarehousesDataTable();
      this.Adapter.Fill((DataTable) warehousesDataTable);
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "Warehouses"
      };
      dataTableMapping.ColumnMappings.Add("WarehouseID", "WarehouseID");
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "dbo.GetWarehouses";
